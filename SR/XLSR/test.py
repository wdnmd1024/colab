...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-dir', type=str, default='exp/first_try_face', help='hyperparameters path')
    parser.add_argument('--SR-rate', type=int, default=4, help='the scale rate for SR')
    parser.add_argument('--model', type=str, default='D:/SR/XLSR/exp/first-try/best.pt', help='the path to the saved model')
